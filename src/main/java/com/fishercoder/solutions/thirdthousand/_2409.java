...
public class _2409 {
    public static class Solution1 {
        ...
        private boolean bothInRome(
                int month,
                int day,
                String[] arriveAliceParts,
                String[] leaveAliceParts,
                String[] arriveBobParts,
                String[] leaveBobParts) {
            ...
            return inRome(
                            ...
                            month,
                            day)
                    && inRome(bobArriveMonth, bobArriveDay, bobLeaveMonth, bobLeaveDay, month, day);
        }

        private boolean inRome(
                int arriveMonth, int arriveDay, int leaveMonth, int leaveDay, int month, int day) {
