        ...
        public String findShortestWay(int[][] maze, int[] ball, int[] hole) {
            ...
            while (!heap.isEmpty()) {
                ...
                for (int i = 0; i < directions.length - 1; i++) {
                    ...
                    // we need below while loop to find only "stop" points that could be put into
                    // the queue
                    while (x >= 0
                            && y >= 0
                            && x < m
            ...
            return points[hole[0]][hole[1]].distance == Integer.MAX_VALUE
                    ? "impossible"
