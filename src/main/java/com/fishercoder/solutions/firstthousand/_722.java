                ...
                for (int i = 0; i < line.length(); i++) {
                    if (line.charAt(i) == '/' && i + 1 < line.length()) {
                        ...
                        if (line.charAt(i + 1) == '*' && !possiblyMultilineComment) {
                            // but cannot break here, because this might be a single line comment,
                            // so we need to find the closing "*/"
                            ...
                            if (!possiblyMultilineComment) {
                                // only at this time, we know this is not part of a possibly
                                // multiline comment,
