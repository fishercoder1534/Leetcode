...
public class _132 {
    ...
    public static class Solution1 {
        ...
        // we initiazlie cut[i] with its max possible value which is i, this is because a single
        // char is naturally a palindrome, so, we'll cut this string into all single-char
        // substrings, which is the max cuts needed
