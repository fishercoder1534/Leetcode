...
public class _488 {
    ...
    public static class Solution1 {
        ...
        int maxcount =
                6; // the max balls you need will not exceed 6 since "The number of balls in your
        ...
        public int findMinStep(String board, String hand) {
            ...
            int result = dfs(board + "#", handCount); // append a "#" to avoid special process while
            // j==board.length, make the code shorter.
