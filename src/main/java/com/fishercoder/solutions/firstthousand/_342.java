...
public class _342 {
    public static class Solution1 {
        ...
        // that is power of four is that its only single one bit must appear on the odd position,
        // and power of two won't meet this requirement
        ...
        // thus, doing AND with 0x55555 will check if the only one bit is located on the odd
        // position, thus ruling out those that are power of 2 but not power of 4
