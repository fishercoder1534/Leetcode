...
public class _283 {
    public static class Solution1 {
        public void moveZeroes(int[] nums) {
            // keep the last non-zero index and keep overwriting it, then append zeroes to fill the
            // end
            int j = 0;
            int i = 0;
            for (; j < nums.length; j++) {
    ...
    // Apparently it's not the most optimal, since this is basically an O(n^2) solution, then I
    // turned to Editorial solutions
