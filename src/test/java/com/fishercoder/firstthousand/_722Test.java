...
public class _722Test {
    ...
    public void test2() {
        assertEquals(
                Arrays.asList("ab"),
                solution1.removeComments(new String[] {"a/*comment", "line", "more_comment*/b"}));
    }
    ...
    public void test4() {
        assertEquals(
                Arrays.asList("main() {", "   double s = 33;", "   cout << s;", "}"),
                solution1.removeComments(
                        new String[] {
                            "main() {",
                            "/* here is commments",
    ...
    public void test5() {
        assertEquals(
                Arrays.asList("void func(int k) {", "   k = k*2/4;", "   k = k/2;*/", "}"),
                solution1.removeComments(
                        new String[] {
                            "void func(int k) {",
