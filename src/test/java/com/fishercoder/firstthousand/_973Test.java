...
public class _973Test {
    ...
    public void test1() {
        assertArrayEquals(
                new int[][] {{-2, 2}}, solution1.kClosest(new int[][] {{1, 3}, {-2, 2}}, 1));
        assertArrayEquals(
                new int[][] {{-2, 2}}, solution2.kClosest(new int[][] {{1, 3}, {-2, 2}}, 1));
    }
    ...
    public void test2() {
        assertArrayEquals(
                new int[][] {{3, 3}, {-2, 4}},
                solution1.kClosest(new int[][] {{3, 3}, {5, -1}, {-2, 4}}, 2));
        assertArrayEquals(
                new int[][] {{-2, 4}, {3, 3}},
                solution2.kClosest(new int[][] {{3, 3}, {5, -1}, {-2, 4}}, 2));
    }
}
