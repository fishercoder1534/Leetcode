...
public class _349Test {
    ...
    public void test1() {
        assertArrayEquals(
                new int[] {2}, solution1.intersection(new int[] {1, 2, 2, 1}, new int[] {2, 2}));
    }

    @Test
    public void test2() {
        assertArrayEquals(
                new int[] {2}, solution2.intersection(new int[] {1, 2, 2, 1}, new int[] {2, 2}));
    }

    @Test
    public void test3() {
        assertArrayEquals(
                new int[] {2}, solution3.intersection(new int[] {1, 2, 2, 1}, new int[] {2, 2}));
    }
}
