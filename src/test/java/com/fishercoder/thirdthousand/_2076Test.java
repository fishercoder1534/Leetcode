...
public class _2076Test {
    ...
    public void test1() {
        restrictions =
                CommonUtils.convertLeetCodeIrregularLengths2DArrayInputIntoJavaArray("[0,1]");
        requests =
                CommonUtils.convertLeetCodeIrregularLengths2DArrayInputIntoJavaArray("[0,2],[2,1]");
    ...
    public void test2() {
        restrictions =
                CommonUtils.convertLeetCodeIrregularLengths2DArrayInputIntoJavaArray("[0,1]");
        requests =
                CommonUtils.convertLeetCodeIrregularLengths2DArrayInputIntoJavaArray("[1,2],[0,2]");
        expected = new boolean[] {true, false};
        n = 3;
        assertArrayEquals(expected, solution1.friendRequests(n, restrictions, requests));
    }
    ...
    public void test4() {
        restrictions =
                CommonUtils.convertLeetCodeIrregularLengths2DArrayInputIntoJavaArray("[0,6],[6,2]");
        requests =
                CommonUtils.convertLeetCodeIrregularLengths2DArrayInputIntoJavaArray(
                        "[0,2],[2,3],[0,2],[6,4],[6,4]");
    ...
    public void test5() {
        restrictions =
                CommonUtils.convertLeetCodeIrregularLengths2DArrayInputIntoJavaArray(
                        "[14,2],[1,8],[4,5],[16,6],[10,8],[10,3],[17,14],[13,2],[5,1],[0,4],"
        ...
        requests =
                CommonUtils.convertLeetCodeIrregularLengths2DArrayInputIntoJavaArray(
                        "[12,0],[4,7],[9,0],[4,5],[4,6],[0,16],[2,15],[1,2],[12,15],"
