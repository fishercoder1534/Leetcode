...
public class _1230Test {
    private _1230.Solution1 solution1;
    ...
    public void test2() {
        assertEquals(
                0.03125, solution1.probabilityOfHeads(new double[] {0.5, 0.5, 0.5, 0.5, 0.5}, 0));
    }
    ...
    public void test6() {
        assertEquals(
                0.31250,
                solution1.probabilityOfHeads(new double[] {0.5, 0.5, 0.5, 0.5, 0.5, 0.5}, 3));
    }
}
