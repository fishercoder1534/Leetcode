...
public class _1628Test {
    ...
    @Test
    public void test2() {
        _1628.Solution1.Node node =
                treeBuilderSolution1.buildTree(new String[] {"3", "4", "+", "2", "*", "7", "/"});
        List<String> list = node.print(node, new ArrayList<>());
        CommonUtils.printList(list);
    ...
    public void test3() {
        _1628.Solution1.Node node =
                treeBuilderSolution1.buildTree(new String[] {"4", "5", "2", "7", "+", "-", "*"});
        List<String> list = node.print(node, new ArrayList<>());
        CommonUtils.printList(list);
    ...
    public void test4() {
        _1628.Solution1.Node node =
                treeBuilderSolution1.buildTree(
                        new String[] {"4", "2", "+", "3", "5", "1", "-", "*", "+"});
        List<String> list = node.print(node, new ArrayList<>());
        CommonUtils.printList(list);
