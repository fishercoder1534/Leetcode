...
import com.fishercoder.solutions.secondthousand._1577;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class _1577Test {
    private _1577.Solution1 solution1;
    ...
    public void test4() {
        assertEquals(
                0,
                solution1.numTriplets(new int[] {4, 7, 9, 11, 23}, new int[] {3, 5, 1024, 12, 18}));
    }
    ...
    public void test7() {
        assertEquals(
                234,
                solution1.numTriplets(
                        new int[] {
                            14, 1, 1, 12, 7, 12, 10, 4, 11, 10, 5, 2, 5, 14, 7, 9, 10, 13, 15, 6, 9,
                            12, 6, 12, 4, 10, 9, 12, 11
                        },
                        new int[] {
                            3, 12, 1, 9, 1, 12, 4, 12, 4, 1, 7, 10, 7, 11, 4, 13, 4, 11, 5, 1, 14,
                            12, 15, 4, 2, 3, 13, 10, 3, 4
                        }));
    }
}
