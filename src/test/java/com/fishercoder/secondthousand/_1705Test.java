...
public class _1705Test {
    ...
    public void test1() {
        assertEquals(
                7, solution1.eatenApples(new int[] {1, 2, 3, 5, 2}, new int[] {3, 2, 1, 4, 2}));
    }
    ...
    public void test2() {
        assertEquals(
                5,
                solution1.eatenApples(new int[] {3, 0, 0, 0, 0, 2}, new int[] {3, 0, 0, 0, 0, 2}));
    }
    ...
    public void test4() {
        assertEquals(
                8, solution1.eatenApples(new int[] {2, 1, 1, 4, 5}, new int[] {10, 10, 6, 4, 2}));
    }
}
